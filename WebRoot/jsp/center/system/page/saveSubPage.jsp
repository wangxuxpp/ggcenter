...
<script type="text/javascript" src="jsp/center/system/page/saveSubPage.js"></script>
</head>
...
<div class="addbill">
	...
	<form action="page.hm?method=saveSub" method="post" id="form" name="form" onsubmit="return false">
		<input type="hidden" id="ID" name="ID" value="${requestMap.ID }" />
		<input type="hidden" id="I_SYS_PAGE_ID" name="I_SYS_PAGE_ID" value="${requestMap.I_SYS_PAGE_ID }" />
